exports.id = "component---src-pages-contact-file-upload-jshead";
exports.ids = ["component---src-pages-contact-file-upload-jshead"];
exports.modules = {
...
/***/ "./src/pages/contact/file-upload.js?export=head":
/*!******************************************************!*\
  !*** ./src/pages/contact/file-upload.js?export=head ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class Contact extends react__WEBPACK_IMPORTED_MODULE_0__.Component {
  constructor(props) {
    ...
    this.handleSubmit = e => {
      ...
      }).then(() => (0,gatsby_link__WEBPACK_IMPORTED_MODULE_2__.navigate)(form.getAttribute("action"))).catch(error => alert(error));
    };
    this.state = {};
  }
  render() {
...
;
//# sourceMappingURL=component---src-pages-contact-file-upload-jshead.js.map