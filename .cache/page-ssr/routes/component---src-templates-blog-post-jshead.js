...
const BlogPostTemplate = ({
  ...
  const PostContent = contentComponent || _components_Content__WEBPACK_IMPORTED_MODULE_5__["default"];
  ...
  }, title), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("p", null, description), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(PostContent, {
    content: content
  }), tags && tags.length ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", {
    style: {
      marginTop: `4rem`
    }
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("h4", null, "Tags"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("ul", {
    className: "taglist"
  }, tags.map(tag => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("li", {
    key: tag + `tag`
...
BlogPostTemplate.propTypes = {
  content: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().node.isRequired),
  contentComponent: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().func),
  ...
  helmet: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().object)
};
const BlogPost = ({
  data
}) => {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_components_Layout__WEBPACK_IMPORTED_MODULE_4__["default"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(BlogPostTemplate, {
    content: post.html,
    ...
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("title", null, `${post.frontmatter.title}`), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("meta", {
      name: "description",
...
BlogPost.propTypes = {
  data: prop_types__WEBPACK_IMPORTED_MODULE_6___default().shape({
    markdownRemark: (prop_types__WEBPACK_IMPORTED_MODULE_6___default().object)
  })
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (BlogPost);
const pageQuery = "2655957122";
